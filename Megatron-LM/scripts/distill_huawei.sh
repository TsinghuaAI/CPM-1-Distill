...
DATA_PATH="${WORKING_DIR}/data/baike_small_text_document"
...
CMD="python -m torch.distributed.launch ${DISTRIBUTED_ARGS} ${WORKING_DIR}/Megatron-LM/distill_gpt2.py $@ ${GPT_OPT}"
